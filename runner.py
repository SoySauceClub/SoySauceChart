...
@click.option('--data_folder', default=r'c:\temp', help='The minute bar folder root')
@click.option('--trade_file', default=None, help='The trade file that shows the actual trades')
@click.option('--out_folder', default=r'c:\temp', help='The folder that contains the output')
